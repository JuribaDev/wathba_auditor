---
name: nafath-yakeen-basics
description: "Keep the agent from inventing fake Nafath or Yakeen endpoints. Explains the approval path, the integration model, and which behaviors you cannot ship without a credential."
---
...
_Version: 0.2.0 · Last verified: 2026-04-24 · Status: draft_

> Engineering guidance, not legal advice. Verify each rule against the official sources below.

**Sources**

- [Nafath service catalog](https://www.my.gov.sa/wps/portal/snp/eParticipation/nafath)
- [Saudi National Single Sign-On](https://www.iam.gov.sa/)
- [Elm Digital Identifiers - Yakeen](https://www.elm.sa/en/our-business/digital-products/Pages/Digital-identifiers.aspx)
- [SAMA Rulebook - Yaqeen for ID Verification](https://www.rulebook.sama.gov.sa/en/yaqeen-id-verification)
